    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('create-manuals') }}" class="btn btn-primary">input</a>
                ...
                <table id="myTable" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('edit-manuals', $item->id) }}" class="btn btn-warning">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('delete-manuals', $item->id) }}" method="POST" style="display: inline;">
                                                    @csrf
                                                    @method('DELETE')
